...
export const MessengerUncheckedUpdateManyWithoutUserInputSchema: z.ZodType<Prisma.MessengerUncheckedUpdateManyWithoutUserInput> = z.object({
  messengerId: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  content: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  boxChatId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default MessengerUncheckedUpdateManyWithoutUserInputSchema;
