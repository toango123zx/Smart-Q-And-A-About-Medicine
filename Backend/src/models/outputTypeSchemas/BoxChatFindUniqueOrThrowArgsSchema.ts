...
export const BoxChatFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.BoxChatFindUniqueOrThrowArgs> = z.object({
  select: BoxChatSelectSchema.optional(),
  include: BoxChatIncludeSchema.optional(),
  where: BoxChatWhereUniqueInputSchema,
}).strict() ;

export default BoxChatFindUniqueOrThrowArgsSchema;
