...
export const MessengerFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.MessengerFindUniqueOrThrowArgs> = z.object({
  select: MessengerSelectSchema.optional(),
  include: MessengerIncludeSchema.optional(),
  where: MessengerWhereUniqueInputSchema,
}).strict() ;

export default MessengerFindUniqueOrThrowArgsSchema;
