...
export const BoxChatCreateArgsSchema: z.ZodType<Prisma.BoxChatCreateArgs> = z.object({
  select: BoxChatSelectSchema.optional(),
  include: BoxChatIncludeSchema.optional(),
  data: z.union([ BoxChatCreateInputSchema,BoxChatUncheckedCreateInputSchema ]),
}).strict() ;

export default BoxChatCreateArgsSchema;
